...
public interface ReceiveItemDao {
    ...
    List<Map<String, Object>> queryByCount(String libraryId, LocalDate startOfWeek, LocalDate endOfWeek);


    List<Map<String, Object>> queryDailyTimeSlotCounts(Map<String, Object> params);

    List<Map<String, Object>> queryReservationCountByCollege(Map<String, Object> params);
}
