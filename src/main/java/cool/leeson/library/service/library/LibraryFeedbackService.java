...
public class LibraryFeedbackService {
    ...
    public Page<LibraryFeedback> queryByPage(LibraryFeedback libraryFeedback, PageRequest pageRequest) {
        int total = (int) this.libraryFeedbackDao.count(libraryFeedback);
     ...
     * @return 实例对象
     */
    public LibraryFeedback update(@RequestBody LibraryFeedback libraryFeedback) {
    ...
    public Map<String, Object> querlist() {
        return ResMap.ok(libraryFeedbackDao.findAll());
    }
}
