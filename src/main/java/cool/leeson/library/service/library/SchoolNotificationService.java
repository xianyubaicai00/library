...
public class SchoolNotificationService {
    private static final Logger log = LoggerFactory.getLogger(SchoolNotificationService.class);
    @Resource
     ...
     * 分野查询信息
     */
    public Page<SchoolNotification> queryBymessagePage(SchoolNotification schoolNotification, PageRequest pageRequest) {
        long total = this.schoolNotificationDao.count(schoolNotification);
