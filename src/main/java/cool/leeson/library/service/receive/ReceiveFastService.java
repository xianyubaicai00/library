...
public class ReceiveFastService {
    ...
    public ReceiveFast insert(ReceiveFast receiveFast) throws MyException {
        ...
        if (receiveFasts.size() > 0) throw new MyException("该座位已有人设置");
     ...
     * @return 实例对象
     */
    public Map<String, Object> update(@RequestBody ReceiveFast receiveFast) throws MyException {
        // 1. 判断receive是否为open
