...
public class SchoolController {
    ...
    public Map<String, Object> getschool(String schoolId) {
        return this.schoolService.querySimple1(schoolId);
    }
     ...
     */
    @PutMapping
    public Map<String, Object> edit(@RequestBody School school) throws MyException {
