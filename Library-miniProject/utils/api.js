...
class Api {
    ...
    queryMessageNotifications = (data) => request.get('notification/message', data)
    ...
    insertNotification = (data) => request.post('notification', data)
    ...
    updatestat = (data) => request.put("/receive/update", data)
    /**
     * 信息反馈
     */
