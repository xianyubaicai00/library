...
export default {
    ...
    // 登录相关API省略...
    queryWeekStatsOldLibrary: (libraryId) => http.get(`api/receiveCount/zhou?libraryId=${libraryId}`),
    queryWeekStatsDigitalLibrary: (libraryId) => http.get(`api/receiveCount/zhou?libraryId=${libraryId}`),
    queryDailyStatsOldLibrary: (libraryId) => http.get(`api/receiveCount/time?libraryId=${libraryId}`),
    queryDailyStatsDigitalLibrary: (libraryId) => http.get(`api/receiveCount/time?libraryId=${libraryId}`),
    queryCollegeCounts: () => http.get("api/receiveCount/xueyuan"),


// 在 api.js 中添加
    queryWeekStats: (data) => http.get("api/receiveCount/zhou", data),
    ...
    queryRoomByTime: (roomId, today, idx) =>
    ...
    updateReceive: (receiveId) =>
        http.put("api/receive/update", {receiveId}),
     ...
     * 获取反馈
     */
    feedbackqueryByPage: (data) => http.get("api/feedback/all", data),
    updateFeedbackStatus: (data) => http.put("api/feedback", data),
    deleteFeedback: (feedbackId) => http.delete("api/feedback", {feedbackId}),
